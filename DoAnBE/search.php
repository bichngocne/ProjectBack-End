...
if (isset($_GET['search'])) {
    ...
    $bookList = $bookModel->getSearchByKey($key);
}
                ...
                <div class="col-md-3 col-lg-3 col-12 frames">
                    <div class='col-book'>
                        ...
                        $photos = explode(',', $item['book_photo']);
                                ?>
                        <img src="<?php echo reset($photos) ?>" alt="" class="img-fluid book__photo" style="width:250px">
                        ...
                        <div class="icon__book">
                            ...
                            <?php if (isset($_SESSION['username'])) { ?>
                                <a href="index.php?like=<?php echo $item['id_book'] ?>"><i class="fa-regular fa-heart"></i></a><?php echo $item['like'] ?>
                            <?php } ?>
